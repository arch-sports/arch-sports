...
format: 
  pdf:
    ...
    fig-height: 2.25
    fig-pos: h
    output-file: '`r gsub("_", "/", params$Team)`'
    output-ext: 'pdf'
...
|    The above graphs show the distribution of testing scores, alongside normative data from Jay Hoffman's *Norms for Fitness, Performance, and Health*[^2], displayed as a grey region showing the 30th to 70th percentile. Note that the normative values are gathered from collegiate athletes.
...
sumtable(select(data, Athlete, CMJ, mRSI, AgilityL, AgilityR, FMS, -Team), simple.kable = TRUE)
